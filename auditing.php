...
<link href="auditing.css" rel="stylesheet">
...
<form name="Search" method="get" action="http://www.google.com/search" enctype="text/plain" id="LayoutGrid7">
<div class="row">
<div class="col-1">
<div id="wb_Image7" style="display:inline-block;width:45px;height:45px;z-index:0;">
<a href="./index.html"><img src="images/t.png" id="Image7" alt="TIM" title="TIM SHERQ Logo"></a>
</div>
<a id="Button4" href="./index.html" style="display:inline-block;width:270px;height:40px;z-index:1;">TIM SHERQ CONSULTANCY</a>
<input type="submit" id="Button8" name="" value="" style="display:inline-block;width:20px;height:25px;z-index:2;">
<div id="wb_Heading4" style="display:inline-block;width:285px;height:25px;z-index:3;">
<h1 id="Heading4">Beyond Health & Safety Compliance    </h1>
</div>
</div>
<div class="col-2">
<form name="SiteSearch1_form" id="SiteSearch1_form" role="search" accept-charset="UTF-8" style="display:inline" onsubmit="return searchPage(features)">
<input type="text" id="SiteSearch1" style="display:block;width: 100%;height:26px;z-index:4;" name="SiteSearch1" value="" spellcheck="false" placeholder="Search " role="searchbox"></form>
</div>
<div class="col-3">
<input type="button" id="Button6" onclick="searchPage();return false;" name="Search" value="Search" style="display:inline-block;width:96px;height:25px;z-index:5;">
</div>
</div>
</form>
</div>
...
<li><a role="menuitem" href="./Construction-Site-Flagman.html">Construction&nbsp;Site&nbsp;Flagman&nbsp;</a></li>
<li><a role="menuitem" href="./Excavation-inspection.html">Excavation&nbsp;inspection</a></li>
</ul>
</li>
<li>
...
<li><a role="menuitem" href="./Overhead-Crane.html">Overhead&nbsp;Crane&nbsp;&nbsp;</a></li>
</ul>
</li>
<li>
...
<li><a role="menuitem" href="./First-aid-level-1.html">First&nbsp;aid&nbsp;level&nbsp;1</a></li>
<li><a role="menuitem" href="./First-aid-level-2.html">First&nbsp;aid&nbsp;level&nbsp;2</a></li>
<li><a role="menuitem" href="./HAZMAT-Handling.html">HAZMAT&nbsp;Handling</a></li>
<li><a role="menuitem" href="./HAZMAT-Storage.html">HAZMAT&nbsp;Storage</a></li>
<li><a role="menuitem" href="./HIRA.html">HIRA</a></li>
<li><a role="menuitem" href="./Confined-Space.html">Confined&nbsp;Space</a></li>
<li><a role="menuitem" href="./OHSA.html">OHSA</a></li>
<li><a role="menuitem" href="./SHE-REP.html">SHE&nbsp;REP</a></li>
<li><a role="menuitem" href="./Legal-Liability.html">Legal&nbsp;Liability</a></li>
</ul>
</li>
<li>
...
<li><a role="menuitem" href="./lawnmowers.html">&nbsp;lawnmowers</a></li>
</ul>
</li>
<li>
...
<li><a role="menuitem" href="./Scaffold-Erecting.html">Scaffold&nbsp;Erecting&nbsp;</a></li>
<li><a role="menuitem" href="./Ladder-inspection.html">Ladder&nbsp;inspection</a></li>
<li><a role="menuitem" href="./Working-at-Heights.html">Working&nbsp;at&nbsp;Heights</a></li>
</ul>
</li>
</ul>
</li>
...
<li><a role="menuitem" href="./Water-Resource-Management-.html" title="Water-Resource-Management-">Water&nbsp;Resource&nbsp;Management-</a></li>
<li><a role="menuitem" href="./Contamination-Assessments.html" title="Contamination-Assessments">Contamination&nbsp;Assessments</a></li>
</ul>
</li>
<li><a role="menuitem" href="./SHERQ-Management-Systems.html" title="SHERQ-Management-Systems">SHERQ&nbsp;Management&nbsp;Systems</a></li>
<li><a role="menuitem" href="./Workplace-Risk-Assessments.html" title="Workplace-Risk-Assessments">Workplace&nbsp;Risk&nbsp;Assessments</a></li>
<li><a role="menuitem" href="./Workplace-inspections-.html" title="Workplace-inspections-">Workplace&nbsp;inspections</a></li>
<li><a role="menuitem" href="./Safety-Files.html" title="Safety Files">Safety&nbsp;Files</a></li>
<li><a role="menuitem" href="./Construction-Safety.html" title="Construction Safety">Construction&nbsp;Safety</a></li>
<li><a role="menuitem" href="./Project-Life-Cycle-.html" title="Project-Life-Cycle-">Project&nbsp;Life&nbsp;Cycle</a></li>
<li><a role="menuitem" href="./Emergency-Evacuation-Plans.html" title="Emergency-Evacuation-Plans">Emergency&nbsp;Evacuation&nbsp;Plans</a></li>
<li><a role="menuitem" href="./Traffic-Management-Plans.html" title="Traffic-Management-Plans">Traffic&nbsp;Management&nbsp;Plans</a></li>
<li><a role="menuitem" href="./Process-Safety-Management-.html" title="Process-Safety-Management-">Process-Safety-Management-</a></li>
<li><a role="menuitem" href="./Loss-Prevention-and-HSE-Design.html" title="Loss-Prevention-and-HSE-Design">Loss&nbsp;Prevention&nbsp;&amp;&nbsp;HSE&nbsp;Design</a></li>
<li><a role="menuitem" href="./Wayleave-Application.html" title="Wayleave Application">Wayleave&nbsp;Application</a></li>
<li><a role="menuitem" href="./Incident-Investigation-.html" title="Incident-Investigation-">Incident&nbsp;Investigation</a></li>
</ul>
</li>
<li><a role="menuitem" href="./contact-us.html"><i class="fa fa-address-card fa-2x">&nbsp;</i><br>Contact&nbsp;Us</a></li>
<li><a role="menuitem" href="./blog.html"><i class="fa fa-book fa-2x">&nbsp;</i><br>Blog</a></li>
</ul>
...
<div id="wb_Card3" style="display:flex;width:100%;text-align:center;z-index:7;">
   <div id="Card3-card-body">
      <div id="Card3-card-item0">AUDITING</div>
      <div id="Card3-card-item1">Tim SHERQ can provide an audit solution to assist your organisation.<br><br></div>
      <div id="Card3-card-item2"><a href="./contact-us.html#LayoutGrid1">ARRANGE YOUR AUDIT TODAY</a></div>
   </div>
...
<div class="carousel-innerframe">
<div id="wb_Card6" style="display:flex;width:100%;text-align:center;z-index:8;">
   <div id="Card6-card-body">
      <div id="Card6-card-item0">Our team have experience in SHERQ Management Systems.<br><br></div>
      <div id="Card6-card-item1">We can review your system/s to assess their structure, strengths and opportunities.</div>
   </div>
...
<div class="carousel-innerframe">
<div id="wb_Card4" style="display:flex;width:100%;text-align:center;z-index:9;">
   <div id="Card4-card-body">
      <div id="Card4-card-item0">Our Lead auditors have gained from their extensive experience <br><br>working in senior roles within some of African's organisations.</div>
   </div>
...
<div id="wb_section1">
<div id="section1">
<div id="wb_Heading1" style="display:inline-block;width:960px;z-index:10;">
<h1 id="Heading1">Our audit services include, but are not limited to</h1>
</div>
...
<div class="col-1">
<div id="wb_Text2">
<span style="color:#FFFFFF;font-family:Arial;font-size:13px;">Copyright © 2016 by &quot;Tim SHERQ Consultancy&quot;·&nbsp; All Rights reserved·&nbsp; E-Mail: info@timsherq.co.za</span><span style="color:#979797;font-family:Arial;font-size:13px;">.</span>
</div>
<div id="wb_FontAwesomeIcon3" style="display:inline-block;width:23px;height:23px;text-align:center;z-index:18;">
<a href="https://www.facebook.com/timsherq.consultancy"><div id="FontAwesomeIcon3"><i class="fa fa-facebook-official"></i></div></a>
</div>
<div id="wb_FontAwesomeIcon2" style="display:inline-block;width:23px;height:23px;text-align:center;z-index:19;">
<a href="https://www.linkedin.com/in/tim-sherq-consultancy-3b2300179/"><div id="FontAwesomeIcon2"><i class="fa fa-linkedin-square"></i></div></a>
</div>
<div id="wb_FontAwesomeIcon4" style="display:inline-block;width:23px;height:23px;text-align:center;z-index:20;">
<a href="https://twitter.com/TimSherq"><div id="FontAwesomeIcon4"><i class="fa fa-twitter"></i></div></a>
</div>
</div>
</div>
</div>
</div>
<div id="ShareThis" style="position:fixed;text-align:left;left:auto;right:20px;top:auto;bottom:20px;width:380px;height:231px;z-index:39;">
<div id="wb_ShareThisTitle" style="position:absolute;left:30px;top:4px;width:210px;height:49px;z-index:22;">
<h1 id="ShareThisTitle">Share This</h1></div>
<div id="wb_ShareThisDescription" style="position:absolute;left:30px;top:65px;width:250px;height:16px;z-index:23;">
<span style="color:#B6B6B6;font-family:Arial;font-size:15px;"><strong>Share this page with your friends!</strong></span></div>
<div id="wb_ShareThisGoogle" style="position:absolute;left:30px;top:185px;width:149px;height:46px;z-index:24;">
<a href="https://www.linkedin.com/in/tim-sherq-consultancy-3b2300179/" target="_blank"><img src="images/img0189.png" id="ShareThisGoogle" alt="" style="width:149px;height:46px;"></a></div>
<div id="wb_ShareThisTwitter" style="position:absolute;left:193px;top:123px;width:149px;height:46px;z-index:25;">
<a href="https://twitter.com/TimSherq" target="_blank"><img src="images/img0190.png" id="ShareThisTwitter" alt="" style="width:149px;height:46px;"></a></div>
<div id="wb_ShareThisPinterest" style="position:absolute;left:193px;top:185px;width:149px;height:46px;z-index:26;">
<a href="http://www.wysiwygwebbuilder.com/" target="_blank"><img src="images/img0191.png" id="ShareThisPinterest" alt="" style="width:149px;height:46px;"></a></div>
<div id="wb_ShareThisFaceBook" style="position:absolute;left:30px;top:123px;width:149px;height:46px;z-index:27;">
<a href="https://www.facebook.com/timsherq.consultancy" target="_blank"><img src="images/img0192.png" id="ShareThisFaceBook" alt="" style="width:149px;height:46px;"></a></div>
<div id="wb_LogoFaceBook" style="position:absolute;left:30px;top:124px;width:27px;height:24px;text-align:center;z-index:28;">
<a href="https://www.facebook.com/timsherq.consultancy" target="_blank"><div id="LogoFaceBook"><i class="fa fa-facebook"></i></div></a></div>
<div id="wb_LogoGoogle" style="position:absolute;left:30px;top:186px;width:27px;height:24px;text-align:center;z-index:29;">
<a href="https://plus.google.com/share?urlhttp%3A%2F%2Fwww.wysiwygwebbuilder.com&t=WYSIWYG%20Web%20Builder" target="_blank"><div id="LogoGoogle"><i class="fa fa-linkedin-square"></i></div></a></div>
<div id="wb_LogoTwitter" style="position:absolute;left:193px;top:124px;width:27px;height:24px;text-align:center;z-index:30;">
<a href="https://twitter.com/TimSherq" target="_blank"><div id="LogoTwitter"><i class="fa fa-twitter"></i></div></a></div>
<div id="wb_LogoPinterest" style="position:absolute;left:193px;top:186px;width:27px;height:24px;text-align:center;z-index:31;">
<a href="http://www.wysiwygwebbuilder.com/" target="_blank"><div id="LogoPinterest"><i class="fa fa-pinterest"></i></div></a></div>
<div id="wb_ShareThisClose" style="position:absolute;left:279px;top:16px;width:24px;height:24px;text-align:center;z-index:32;">
